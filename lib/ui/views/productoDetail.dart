...
final TextStyle cantPiezasStyle = TextStyle(fontSize: 16,fontFamily: "Poppins-Medium",color: Colors.grey,fontWeight: FontWeight.w500);
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Center(
                        child: Text(product.nombre,style: nombreProductoStyle,textAlign: TextAlign.center),
                      ),
                    ),
                    Center(
                      child: Text("\₡${(product.precio).toStringAsFixed(0)}",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w600,color: Colors.blue)),
                    ),
                    Container(
                      padding: EdgeInsets.symmetric(vertical: 20.0 / 2, horizontal: 20),
                      child: Text(product.descripcion,style: descripcionProductoStyle,textAlign: TextAlign.justify),
                    ),
                    SizedBox(height: 10.0),
                    Row(children: <Widget>[
                      SizedBox(width: 20),
                      Text("Cantidad de piezas:", style: nombrecantPStyle),
                      Text(" " + "${product.cantPiezas.toString()}",style: cantPiezasStyle),
                      SizedBox(width: 15),
                    ]),
                    SizedBox(height: 10.0),
                    Row(children: <Widget>[
