      ...
      body: SafeArea(
        child: Column(
          ...
          children: <Widget>[
            ...
            Center(
              child: Text("Perfil",style: TextStyle(color: Colors.black,fontFamily: "Poppins-Bold",fontSize: 26,fontWeight: FontWeight.w700)),
            ),
            SizedBox(height: 5),
            Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(image: AssetImage('images/lego_M.jpg')),
