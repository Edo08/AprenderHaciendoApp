...
final TextStyle nombreStyle = TextStyle(fontSize: 18,fontFamily: "Poppins-Medium",color: Colors.white,fontWeight: FontWeight.w700);
final TextStyle subTitleStyle = TextStyle(fontFamily: "Poppins-Medium",color: Colors.white,fontWeight: FontWeight.w700,
  shadows: <Shadow>[Shadow(offset: Offset(3.0, 1.0),blurRadius: 3.0,color: Color.fromARGB(150, 0, 0, 0))]);
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(colors: [Color(0xFFf0c419), Color(0xFFf7d759)],begin: Alignment.topCenter,end: Alignment.bottomRight),
          ...
          SizedBox(
            ...
            child: Column(
              children: <Widget>[
                ...
                SizedBox(height: 10),
                Text("Direccion de Entrega",style: nombreStyle,),
